...
const FixRequestSuggestChangesReview: FunctionComponent<NavigationProps<FixSuggestChangesReviewProps>> = (
  props: NavigationProps<FixSuggestChangesReviewProps>,
) => {
  const navigation = useNavigation();
  const user = useSelector((storeState: StoreState) => storeState.user);

  const { fix, notificationId, cost, comments } = props.route.params;
...
export default FixRequestSuggestChangesReview;
